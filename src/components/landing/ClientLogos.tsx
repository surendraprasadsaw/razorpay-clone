...
const logos = [
  {
    name: 'Unacademy',
    logo: (
      <svg fill="currentColor" viewBox="0 0 114 26" className="h-6 w-auto">
  ...
  {
    name: 'PaisaBazaar',
    logo: <span className="font-serif text-2xl">paisabazaar<span className="text-sm">.com</span></span>
  },
  {
    name: 'Nykaa',
    logo: (
      <svg fill="none" viewBox="0 0 100 30" className="h-8 w-auto text-gray-500">
  ...
  },
  {
    name: 'Zerodha',
    logo: (
      <svg fill="currentColor" viewBox="0 0 120 25" className="h-5 w-auto">
  ...
  {
    name: 'Goibibo',
    logo: <span className="font-sans text-2xl font-bold text-blue-600">goibibo</span>
  },
  {
    name: 'Cure.fit',
    logo: (
       <svg fill="currentColor" viewBox="0 0 85 24" className="h-6 w-auto">
  ...
  {
    name: 'ClearTax',
    logo: <span className="font-sans text-2xl font-semibold">Clear<span className="font-light">Tax</span></span>
  },
  {
    name: 'BookMyShow',
    logo: (
      <svg fill="currentColor" viewBox="0 0 100 20" className="h-6 w-auto">
    ...
    <div className="relative w-full py-12 bg-background overflow-hidden">
      ...
      >
        {[...logos, ...logos].map((logo, index) => (
          <div key={index} className="flex-shrink-0 mx-8 flex items-center justify-center text-gray-500" style={{ minWidth: '150px' }}>
            {logo.logo}
          </div>
        ))}
      </div>
